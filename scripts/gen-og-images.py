...
PAGES = {
    ...
    'services-project-support': (['Project Support', '& Overflow.'], 'Senior remote hands to hit your deadline.'),
    'services-support-maintenance': (['Support &', 'Maintenance.'], 'Keep data, BI & IT systems running — remotely.'),
    'services-training': (['Training &', 'Enablement.'], 'Hands-on remote upskilling on BI, SQL & data.'),
